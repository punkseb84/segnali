...
Il file `tradingview_strategy.pine` contiene una strategia Pine Script v5 che replica le regole del worker Python per fare backtest su TradingView.
...
- La strategia usa stop loss e due target come il bot Python.
