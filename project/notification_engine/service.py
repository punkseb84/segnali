...
class NotificationEngine:
    ...
    def format_signal(self, payload: dict[str, Any]) -> str:
        return (
            ...
            f"Costi stimati Binance: buy fee €{payload.get('estimated_buy_fee_eur'):.4f}, sell fee €{payload.get('estimated_sell_fee_eur'):.4f}, spread €{payload.get('estimated_spread_cost_eur'):.4f}\n"
