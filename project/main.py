...
def build_strategy_engine(
    ...
    event_bus: EventBus,
) -> RegimeEconomicsFirstStrategyEngine:
    return RegimeEconomicsFirstStrategyEngine(
        research_repository,
        decision_engine,
        event_bus,
...
def main() -> None:
    ...
    logger.info("======================================")
    logger.info("PROJECT MAIN VERSION: 2026-07-16 REGIME ECONOMICS FIRST BUILD")
    logger.info("======================================")
    event_bus = EventBus()
    ...
    logger.info(
        "Regime/economics signal selection | min_research_trades=%s require_regime_alignment=%s dynamic_target=%s",
